...
const FIELDS: { key: string; label: string; get: (d: DecaPayloadData) => string }[] = [
  ...
  },
  {
    ...
    label: "Lugar de carga — nombre",
    get: (d) => d.loadLocation?.name ?? "",
  },
  {
    key: "loadLocation.address",
    label: "Lugar de carga — dirección",
    get: (d) => d.loadLocation?.address ?? "",
  },
  {
    key: "loadLocation.city",
    label: "Lugar de carga — localidad",
    get: (d) => d.loadLocation?.city ?? "",
  },
  {
    key: "loadLocation.province",
    label: "Lugar de carga — provincia",
    get: (d) => d.loadLocation?.province ?? "",
  },
  {
    key: "unloadLocation.name",
    label: "Lugar de descarga — nombre",
    get: (d) => d.unloadLocation?.name ?? "",
  },
  {
    key: "unloadLocation.address",
    label: "Lugar de descarga — dirección",
    get: (d) => d.unloadLocation?.address ?? "",
  },
  {
    key: "unloadLocation.city",
    label: "Lugar de descarga — localidad",
    get: (d) => d.unloadLocation?.city ?? "",
  },
  {
    key: "unloadLocation.province",
    label: "Lugar de descarga — provincia",
    get: (d) => d.unloadLocation?.province ?? "",
  },
  { key: "loadDate", label: "Fecha de carga", get: (d) => d.loadDate ?? "" },
  { key: "unloadDate", label: "Fecha de descarga", get: (d) => d.unloadDate ?? "" },
