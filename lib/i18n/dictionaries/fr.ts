...
export const fr = {
  ...
  panel: {
    ...
    empresa: {
      incompleteTitle: "Complétez les données de votre entreprise",
      incompleteBody: "pour pouvoir générer de nouveaux DeCA.",
      missingEditable: "Manquant ou invalide, ci-dessous : ",
      missingAskAdmin: "Demandez au responsable de compléter : ",
      identifierIssue:
        "La raison sociale ou le NIF de l'entreprise n'est pas correct ; contactez le support pour le corriger.",
      companyDataHeading: "Données de l'entreprise",
      nameLabel: "Nom ou raison sociale",
      nifLabel: "NIF",
      contactDataHeading: "Coordonnées",
      contactDataIntro:
        "Email, téléphone, adresse et personne de contact de l'entreprise — visible uniquement dans votre espace de travail.",
      logoHeading: "Logo sur le PDF",
      logoIntro:
        "Il apparaîtra dans l'en-tête des DeCA que vous générerez à partir de maintenant. Les documents déjà générés ne changent pas.",
      offlineError: "Pas de connexion. Réessayez.",
      profile: {
      ...
      logo: {
        altText: "Logo de l'entreprise",
        noneConfigured: "Aucun logo défini. Seul un administrateur peut en ajouter un.",
        invalidFormat:
          "Le logo doit être une image PNG ou JPEG. Le SVG et les autres formats ne sont pas pris en charge.",
        tooLarge: (kb: number) => `Le logo doit peser au maximum ${kb} Ko.`,
        ...
        hint: (kb: number) => `PNG ou JPEG, ${kb} Ko maximum.`,
      },
    },
    datos: {
      intro:
        "Enregistrez et réutilisez les données que vous utilisez souvent pour créer vos DeCA plus vite.",
      countLabel: (c: { company: number; vehicle: number; location: number; shipment: number }) =>
        `${c.company} entreprises · ${c.vehicle} véhicules · ${c.location} lieux · ${c.shipment} itinéraires`,
      searchLabel: "Rechercher dans les données habituelles",
      searchPlaceholder: "Rechercher dans les données habituelles…",
      addMenuTrigger: "+ Ajouter une donnée habituelle",
      addMenuItem: (label: string) => `+ Ajouter ${label}`,
      saveError: "Impossible d'enregistrer. Vérifiez les données.",
      offlineError: "Pas de connexion.",
      removeError: "Impossible de supprimer.",
      tabsLabel: "Catégories de données habituelles",
      footerNote:
        "Modifier ou supprimer une donnée habituelle ne change aucun DeCA déjà généré : chaque document conserve sa propre copie.",
      noResults: "Aucun résultat pour cette recherche dans cette catégorie.",
      use: "Utiliser",
      edit: "Modifier",
      close: "Fermer",
      delete: "Supprimer",
      ...
      save: "Enregistrer",
      cancel: "Annuler",
      addFirst: (label: string) => `+ Ajouter un premier ${label}`,
      add: (label: string) => `+ Ajouter ${label}`,
      addTitle: (label: string) => `Ajouter ${label}`,
      duplicateFoundPrefix: "Une donnée similaire existe déjà : ",
      useExisting: "Utiliser l'existante",
      saveAnyway: "Enregistrer quand même",
      tabs: {
        company: "Entreprises et contacts",
        vehicle: "Véhicules",
        location: "Lieux",
        shipment: "Itinéraires / envois habituels",
      },
      addLabels: {
        company: "une entreprise",
        vehicle: "un véhicule",
        location: "un lieu",
        shipment: "un itinéraire",
      },
      company: {
        roleLabel: {
          shipper: "Chargeur contractuel",
          carrier: "Transporteur effectif",
          both: "Chargeur et transporteur",
        },
        emptyTitle: "Vous n'avez pas encore d'entreprises enregistrées",
        emptyBody:
          "Enregistrez vos chargeurs et transporteurs habituels pour remplir vos DeCA en quelques secondes.",
        contactPrefix: "Contact : ",
        roleFieldLabel: "Rôle habituel",
        nameLabel: "Nom ou raison sociale",
        nifLabel: "NIF",
        addressLabel: "Domicile",
        postalCodeLabel: "Code postal",
        cityLabel: "Ville",
        contactNameLabel: "Personne de contact (facultatif)",
        contactPhoneLabel: "Téléphone de contact (facultatif)",
        contactEmailLabel: "Email de contact (facultatif)",
      },
      vehicle: {
        emptyTitle: "Vous n'avez pas encore de véhicules enregistrés",
        emptyBody:
          "Enregistrez vos tracteurs et remorques habituels pour ne plus jamais ressaisir la plaque.",
        trailerPrefix: "Remorque ",
        aliasLabel: "Alias (facultatif, ex. «Camion 1»)",
        tractorLabel: "Plaque tracteur",
        trailerLabel: "Plaque remorque (facultatif)",
      },
      location: {
        typeLabel: {
          load: "Chargement",
          unload: "Déchargement",
          both: "Chargement et déchargement",
        },
        emptyTitle: "Vous n'avez pas encore de lieux enregistrés",
        emptyBody:
          "Enregistrez entrepôts, usines et destinations habituelles pour remplir vos DeCA en quelques secondes.",
        usageFieldLabel: "Usage habituel",
        usageOptions: {
          both: "Chargement et déchargement",
          load: "Chargement uniquement",
          unload: "Déchargement uniquement",
        },
        nameLabel: "Entreprise / établissement",
        addressLabel: "Adresse",
        postalCodeLabel: "Code postal",
        cityLabel: "Ville",
      ...
      shipment: {
        emptyTitle: "Vous n'avez pas encore d'itinéraires habituels",
        needTwoLocations:
          "Vous avez besoin d'au moins 2 lieux enregistrés (chargement et déchargement) avant de créer un itinéraire habituel.",
        emptyBody:
          "Enregistrez les trajets que vous répétez pour les ajouter comme envois en un clic.",
        recipientPrefix: "Destinataire : ",
        nameLabel: "Nom de l'itinéraire (facultatif)",
        loadLocationLabel: "Lieu de chargement",
        unloadLocationLabel: "Lieu de déchargement",
        selectPlaceholder: "Sélectionnez un lieu enregistré…",
        goodsLabel: "Marchandise habituelle (facultatif)",
        weightLabel: "Poids habituel (facultatif)",
        recipientLabel: "Destinataire (facultatif)",
      },
    },
  },
  historico: {
