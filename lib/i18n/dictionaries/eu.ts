...
export const eu = {
  ...
  historico: {
    ...
    noResultsFiltered: "Ez da DeCA-rik aurkitu",
    noResultsFilteredHint: "Aldatu iragazkiak edo ezabatu bilaketa-irizpideren bat.",
  ...
  crear: {
    ...
    commercialShare: {
      ...
      channels: { email: "Posta elektronikoa", phone: "WhatsApp", both: "Posta eta WhatsApp" },
      preferredDestinationHint: "Zein posta-kodetarako jaso nahi dituzu eskaintzak?",
      preferredDestinationPostalCode: "Helmuga hobetsiaren posta-kodea",
      preferredDestinationCountry: "Helmuga hobetsiaren herrialdea",
      capacityLegend: "Karga-disponibilitatea",
      capacityFull: "Kamioi osoa",
      capacityFullHint: "Ibilgailua guztiz erabilgarri egongo da.",
      capacityPartial: "Taldekatzea",
      capacityPartialHint: "Lekuaren zati bat baino ez duzu erabilgarri.",
      linearMeters: "Metro lineal erabilgarriak",
      maxWeightKg: "Gehienezko pisu erabilgarria (kg)",
      ...
      privacyVoluntary:
        "Helmuga hobetsia, ibilgailu mota eta erabilgarri dagoen edukiera zuk borondatez adierazitako datuak dira, eskaintza bateragarriak jasotzeko.",
