...
export const eu = {
  ...
  panel: {
    ...
    datos: {
      intro:
        "Sarritan erabiltzen dituzun datuak gorde eta berrerabili zure DeCAak azkarrago sortzeko.",
      countLabel: (c: { company: number; vehicle: number; location: number; shipment: number }) =>
        `${c.company} enpresa · ${c.vehicle} ibilgailu · ${c.location} leku · ${c.shipment} ibilbide`,
      searchLabel: "Bilatu ohiko datuetan",
      searchPlaceholder: "Bilatu ohiko datuetan…",
      addMenuTrigger: "+ Gehitu ohiko datua",
      addMenuItem: (label: string) => `+ Gehitu ${label}`,
      saveError: "Ezin izan da gorde. Egiaztatu datuak.",
      offlineError: "Konexiorik gabe.",
      removeError: "Ezin izan da ezabatu.",
      tabsLabel: "Ohiko datuen kategoriak",
      footerNote:
        "Ohiko datu bat editatzeak edo ezabatzeak ez du aldatzen jada sortutako DeCArik: dokumentu bakoitzak bere kopia gordetzen du.",
      noResults: "Ez dago emaitzarik bilaketa honetarako kategoria honetan.",
      use: "Erabili",
      edit: "Editatu",
      close: "Itxi",
      delete: "Ezabatu",
      ...
      save: "Gorde",
      cancel: "Utzi",
      addFirst: (label: string) => `+ Gehitu lehen ${label}`,
      add: (label: string) => `+ Gehitu ${label}`,
      addTitle: (label: string) => `Gehitu ${label}`,
      duplicateFoundPrefix: "Antzeko datu bat badago jada: ",
      useExisting: "Erabili dagoena",
      saveAnyway: "Gorde hala ere",
      tabs: {
        company: "Enpresak eta kontaktuak",
        vehicle: "Ibilgailuak",
        location: "Lekuak",
        shipment: "Ohiko ibilbideak / bidalketak",
      },
      addLabels: {
        company: "enpresa bat",
        vehicle: "ibilgailu bat",
        location: "leku bat",
        shipment: "ibilbide bat",
      },
      company: {
        roleLabel: {
          shipper: "Kontratu-bidezko kargatzailea",
          carrier: "Garraiolari eragilea",
          both: "Kargatzailea eta garraiolaria",
        },
        emptyTitle: "Oraindik ez duzu gordetako enpresarik",
        emptyBody: "Gorde ohiko kargatzaileak eta garraiolariak zure DeCAak segundotan betetzeko.",
        contactPrefix: "Kontaktua: ",
        roleFieldLabel: "Ohiko rola",
        nameLabel: "Izena edo izen soziala",
        nifLabel: "IFZ",
        addressLabel: "Helbidea",
        postalCodeLabel: "Posta-kodea",
        cityLabel: "Herria",
        contactNameLabel: "Kontaktu-pertsona (aukerakoa)",
        contactPhoneLabel: "Kontaktu-telefonoa (aukerakoa)",
        contactEmailLabel: "Kontaktu-emaila (aukerakoa)",
      },
      vehicle: {
        emptyTitle: "Oraindik ez duzu gordetako ibilgailurik",
        emptyBody:
          "Gorde zure ohiko traktoreak eta atoiak matrikula berriz idatzi behar ez izateko.",
        trailerPrefix: "Atoia ",
        aliasLabel: "Ezizena (aukerakoa, adib. «1. kamioia»)",
        tractorLabel: "Traktorearen matrikula",
        trailerLabel: "Atoiaren matrikula (aukerakoa)",
      },
      location: {
        typeLabel: { load: "Karga", unload: "Deskarga", both: "Karga eta deskarga" },
        emptyTitle: "Oraindik ez duzu gordetako lekurik",
        emptyBody: "Gorde biltegiak, fabrikak eta ohiko helmugak zure DeCAak segundotan betetzeko.",
        usageFieldLabel: "Ohiko erabilera",
        usageOptions: {
          both: "Karga eta deskarga",
          load: "Karga soilik",
          unload: "Deskarga soilik",
        },
        nameLabel: "Enpresa / establezimendua",
        addressLabel: "Helbidea",
        postalCodeLabel: "Posta-kodea",
        cityLabel: "Herria",
        provinceLabel: "Probintzia",
        countryLabel: "Herrialdea",
      },
      shipment: {
        emptyTitle: "Oraindik ez duzu ohiko ibilbiderik",
        needTwoLocations:
          "Gutxienez 2 leku gordeta izan behar dituzu (karga eta deskarga) ohiko ibilbide bat sortu aurretik.",
        emptyBody: "Gorde errepikatzen dituzun ibilbideak, klik batean bidalketa gisa gehitzeko.",
        recipientPrefix: "Hartzailea: ",
        nameLabel: "Ibilbidearen izena (aukerakoa)",
        loadLocationLabel: "Karga-lekua",
        unloadLocationLabel: "Deskarga-lekua",
        selectPlaceholder: "Aukeratu gordetako leku bat…",
        goodsLabel: "Ohiko salgaia (aukerakoa)",
        weightLabel: "Ohiko pisua (aukerakoa)",
        recipientLabel: "Hartzailea (aukerakoa)",
      },
    },
  },
  historico: {
