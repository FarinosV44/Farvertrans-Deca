...
export const ca = {
  ...
  panel: {
    ...
    datos: {
      intro: "Desa i reutilitza les dades que fas servir sovint per crear els teus DeCA més ràpid.",
      countLabel: (c: { company: number; vehicle: number; location: number; shipment: number }) =>
        `${c.company} empreses · ${c.vehicle} vehicles · ${c.location} llocs · ${c.shipment} rutes`,
      searchLabel: "Cerca a les dades habituals",
      searchPlaceholder: "Cerca a les dades habituals…",
      addMenuTrigger: "+ Afegir dada habitual",
      addMenuItem: (label: string) => `+ Afegir ${label}`,
      saveError: "No s'ha pogut desar. Revisa les dades.",
      offlineError: "Sense connexió.",
      removeError: "No s'ha pogut eliminar.",
      tabsLabel: "Categories de dades habituals",
      footerNote:
        "Editar o esborrar una dada habitual no canvia cap DeCA ja generat: cada document desa la seva pròpia còpia.",
      noResults: "Cap resultat per a aquesta cerca en aquesta categoria.",
      use: "Utilitzar",
      edit: "Editar",
      close: "Tancar",
      delete: "Esborrar",
      ...
      save: "Desar",
      cancel: "Cancel·lar",
      addFirst: (label: string) => `+ Afegir el primer ${label}`,
      add: (label: string) => `+ Afegir ${label}`,
      addTitle: (label: string) => `Afegir ${label}`,
      duplicateFoundPrefix: "Ja existeix una dada semblant: ",
      useExisting: "Utilitzar l'existent",
      saveAnyway: "Desar de totes maneres",
      tabs: {
        company: "Empreses i contactes",
        vehicle: "Vehicles",
        location: "Llocs",
        shipment: "Rutes / enviaments habituals",
      },
      addLabels: {
        company: "empresa",
        vehicle: "vehicle",
      ...
      company: {
        roleLabel: {
          ...
          both: "Carregador i transportista",
        },
        emptyTitle: "Encara no tens empreses desades",
        emptyBody:
          "Desa carregadors i transportistes habituals per omplir els teus DeCA en segons.",
        contactPrefix: "Contacte: ",
        roleFieldLabel: "Rol habitual",
        nameLabel: "Nom o raó social",
        nifLabel: "NIF",
        addressLabel: "Domicili",
        postalCodeLabel: "Codi postal",
        cityLabel: "Població / localitat",
        contactNameLabel: "Persona de contacte (opcional)",
        contactPhoneLabel: "Telèfon de contacte (opcional)",
        contactEmailLabel: "Correu de contacte (opcional)",
      },
      vehicle: {
        emptyTitle: "Encara no tens vehicles desats",
        emptyBody:
          "Desa les teves tractores i remolcs habituals perquè no hagis de tornar a escriure la matrícula.",
        trailerPrefix: "Remolc ",
        aliasLabel: "Àlies (opcional, p. ex. «Camió 1»)",
        tractorLabel: "Matrícula tractora",
        trailerLabel: "Matrícula remolc (opcional)",
      },
      location: {
        typeLabel: { load: "Càrrega", unload: "Descàrrega", both: "Càrrega i descàrrega" },
        emptyTitle: "Encara no tens llocs desats",
        emptyBody:
          "Desa magatzems, fàbriques i destinacions habituals per omplir els teus DeCA en segons.",
        usageFieldLabel: "Ús habitual",
        usageOptions: {
          both: "Càrrega i descàrrega",
          load: "Només càrrega",
          unload: "Només descàrrega",
        },
        nameLabel: "Empresa / establiment",
        addressLabel: "Adreça",
        postalCodeLabel: "Codi postal",
        cityLabel: "Localitat",
      ...
      shipment: {
        emptyTitle: "Encara no tens rutes habituals",
        needTwoLocations:
          "Necessites com a mínim 2 llocs desats (càrrega i descàrrega) abans de crear una ruta habitual.",
        emptyBody: "Desa els trajectes que repeteixes per afegir-los com a enviaments amb un clic.",
        recipientPrefix: "Destinatari: ",
        nameLabel: "Nom de la ruta (opcional)",
        loadLocationLabel: "Lloc de càrrega",
        unloadLocationLabel: "Lloc de descàrrega",
        selectPlaceholder: "Selecciona un lloc desat…",
        goodsLabel: "Mercaderia habitual (opcional)",
        weightLabel: "Pes habitual (opcional)",
        recipientLabel: "Destinatari (opcional)",
      },
    },
  },
  historico: {
  ...
  crear: {
    ...
    commercialShare: {
      ...
      channels: { email: "Correu electrònic", phone: "WhatsApp", both: "Correu i WhatsApp" },
      preferredDestinationHint: "Per a quin codi postal t'interessa rebre ofertes?",
      preferredDestinationPostalCode: "Codi postal de destinació preferent",
      preferredDestinationCountry: "País de destinació preferent",
      ...
      capacityPartial: "Grupatge",
      capacityPartialHint: "Només tens part de l'espai disponible.",
      linearMeters: "Metres lineals disponibles",
      maxWeightKg: "Pes màxim disponible (kg)",
      ...
      privacyVoluntary:
        "La destinació preferent, el tipus de vehicle i la capacitat disponible són dades que tu indiques voluntàriament per rebre ofertes compatibles.",
