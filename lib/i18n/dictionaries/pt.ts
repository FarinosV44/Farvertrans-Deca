...
export const pt = {
  ...
  panel: {
    ...
    datos: {
      intro:
        "Guarde e reutilize os dados que usa frequentemente para criar os seus DeCA mais rápido.",
      countLabel: (c: { company: number; vehicle: number; location: number; shipment: number }) =>
        `${c.company} empresas · ${c.vehicle} veículos · ${c.location} locais · ${c.shipment} rotas`,
      searchLabel: "Pesquisar nos dados habituais",
      searchPlaceholder: "Pesquisar nos dados habituais…",
      addMenuTrigger: "+ Adicionar dado habitual",
      addMenuItem: (label: string) => `+ Adicionar ${label}`,
      saveError: "Não foi possível guardar. Verifique os dados.",
      offlineError: "Sem ligação.",
      removeError: "Não foi possível eliminar.",
      tabsLabel: "Categorias de dados habituais",
      footerNote:
        "Editar ou eliminar um dado habitual não altera nenhum DeCA já gerado: cada documento guarda a sua própria cópia.",
      noResults: "Nenhum resultado para esta pesquisa nesta categoria.",
      use: "Usar",
      edit: "Editar",
      close: "Fechar",
      delete: "Eliminar",
      ...
      save: "Guardar",
      cancel: "Cancelar",
      addFirst: (label: string) => `+ Adicionar o primeiro ${label}`,
      add: (label: string) => `+ Adicionar ${label}`,
      addTitle: (label: string) => `Adicionar ${label}`,
      duplicateFoundPrefix: "Já existe um dado semelhante: ",
      ...
      tabs: {
        ...
        vehicle: "Veículos",
        location: "Locais",
        shipment: "Rotas / envios habituais",
      },
      addLabels: {
        company: "empresa",
        vehicle: "veículo",
      ...
      company: {
        roleLabel: {
          shipper: "Expedidor contratual",
          carrier: "Transportador efetivo",
          both: "Expedidor e transportador",
        },
        emptyTitle: "Ainda não tem empresas guardadas",
        emptyBody:
          "Guarde expedidores e transportadores habituais para preencher os seus DeCA em segundos.",
        contactPrefix: "Contacto: ",
        roleFieldLabel: "Função habitual",
        nameLabel: "Nome ou razão social",
        nifLabel: "NIF",
        addressLabel: "Morada",
        postalCodeLabel: "Código postal",
        cityLabel: "Localidade",
        contactNameLabel: "Pessoa de contacto (opcional)",
        contactPhoneLabel: "Telefone de contacto (opcional)",
        contactEmailLabel: "Email de contacto (opcional)",
      },
      vehicle: {
        emptyTitle: "Ainda não tem veículos guardados",
        emptyBody:
          "Guarde os seus tratores e reboques habituais para nunca mais escrever a matrícula.",
        trailerPrefix: "Reboque ",
        aliasLabel: "Alcunha (opcional, ex. «Camião 1»)",
        tractorLabel: "Matrícula do trator",
        trailerLabel: "Matrícula do reboque (opcional)",
      },
      location: {
        typeLabel: { load: "Carga", unload: "Descarga", both: "Carga e descarga" },
        emptyTitle: "Ainda não tem locais guardados",
        emptyBody:
          "Guarde armazéns, fábricas e destinos habituais para preencher os seus DeCA em segundos.",
        usageFieldLabel: "Uso habitual",
        usageOptions: { both: "Carga e descarga", load: "Só carga", unload: "Só descarga" },
        nameLabel: "Empresa / estabelecimento",
        addressLabel: "Morada",
        postalCodeLabel: "Código postal",
        cityLabel: "Localidade",
      ...
      shipment: {
        emptyTitle: "Ainda não tem rotas habituais",
        needTwoLocations:
          "Precisa de pelo menos 2 locais guardados (carga e descarga) antes de criar uma rota habitual.",
        emptyBody: "Guarde os trajetos que repete para os adicionar como envios com um clique.",
        recipientPrefix: "Destinatário: ",
        nameLabel: "Nome da rota (opcional)",
        loadLocationLabel: "Local de carga",
        unloadLocationLabel: "Local de descarga",
        selectPlaceholder: "Selecione um local guardado…",
        goodsLabel: "Mercadoria habitual (opcional)",
  ...
  historico: {
    ...
    truncatedNotice: (total: number, cap: number) =>
      `A mostrar os ${cap} documentos mais recentes de um total de ${total}. Use os filtros para restringir a pesquisa; os documentos mais antigos não aparecem aqui.`,
  ...
  crear: {
    ...
    commercialShare: {
      ...
      destinationPostalCode: "Código postal de disponibilidade",
      destinationPostalCodeHint:
        "O valor principal para o emparelhamento. O endereço exato nunca é partilhado.",
      ...
      channels: { email: "E-mail", phone: "WhatsApp", both: "E-mail e WhatsApp" },
      preferredDestinationHint: "Para que código postal tem interesse em receber ofertas?",
      preferredDestinationPostalCode: "Código postal de destino preferencial",
      preferredDestinationCountry: "País de destino preferencial",
      ...
      vehicleTypeOtherPlaceholder: "Especifique o tipo",
