...
export const it = {
  ...
  panel: {
    ...
    datos: {
      intro: "Salva e riutilizza i dati che usi spesso per creare i tuoi DeCA più velocemente.",
      countLabel: (c: { company: number; vehicle: number; location: number; shipment: number }) =>
        `${c.company} aziende · ${c.vehicle} veicoli · ${c.location} luoghi · ${c.shipment} percorsi`,
      searchLabel: "Cerca nei dati abituali",
      searchPlaceholder: "Cerca nei dati abituali…",
      addMenuTrigger: "+ Aggiungi dato abituale",
      addMenuItem: (label: string) => `+ Aggiungi ${label}`,
      saveError: "Impossibile salvare. Controlla i dati.",
      offlineError: "Nessuna connessione.",
      removeError: "Impossibile eliminare.",
      tabsLabel: "Categorie di dati abituali",
      footerNote:
        "Modificare o eliminare un dato abituale non cambia nessun DeCA già generato: ogni documento conserva la propria copia.",
      noResults: "Nessun risultato per questa ricerca in questa categoria.",
      use: "Usa",
      edit: "Modifica",
      close: "Chiudi",
      delete: "Elimina",
      ...
      save: "Salva",
      cancel: "Annulla",
      addFirst: (label: string) => `+ Aggiungi il primo ${label}`,
      add: (label: string) => `+ Aggiungi ${label}`,
      addTitle: (label: string) => `Aggiungi ${label}`,
      duplicateFoundPrefix: "Esiste già un dato simile: ",
      useExisting: "Usa quello esistente",
      saveAnyway: "Salva comunque",
      tabs: {
        company: "Aziende e contatti",
        vehicle: "Veicoli",
        location: "Luoghi",
        shipment: "Percorsi / spedizioni abituali",
      },
      addLabels: {
        company: "un'azienda",
        vehicle: "un veicolo",
        location: "un luogo",
        shipment: "un percorso",
      },
      company: {
        roleLabel: {
          shipper: "Mittente contrattuale",
          carrier: "Vettore effettivo",
          both: "Mittente e vettore",
        },
        emptyTitle: "Non hai ancora aziende salvate",
        emptyBody: "Salva mittenti e vettori abituali per compilare i tuoi DeCA in pochi secondi.",
        contactPrefix: "Contatto: ",
        roleFieldLabel: "Ruolo abituale",
        nameLabel: "Nome o ragione sociale",
        nifLabel: "Partita IVA",
        addressLabel: "Domicilio",
        postalCodeLabel: "Codice postale",
        cityLabel: "Città / località",
        contactNameLabel: "Persona di contatto (opzionale)",
        contactPhoneLabel: "Telefono di contatto (opzionale)",
        contactEmailLabel: "Email di contatto (opzionale)",
      },
      vehicle: {
        emptyTitle: "Non hai ancora veicoli salvati",
        emptyBody:
          "Salva le tue trattrici e i tuoi rimorchi abituali per non dover più scrivere la targa.",
        trailerPrefix: "Rimorchio ",
        aliasLabel: "Alias (opzionale, es. «Camion 1»)",
        tractorLabel: "Targa trattrice",
        trailerLabel: "Targa rimorchio (opzionale)",
      },
      location: {
        typeLabel: { load: "Carico", unload: "Scarico", both: "Carico e scarico" },
        emptyTitle: "Non hai ancora luoghi salvati",
        emptyBody:
          "Salva magazzini, stabilimenti e destinazioni abituali per compilare i tuoi DeCA in pochi secondi.",
        usageFieldLabel: "Uso abituale",
        usageOptions: { both: "Carico e scarico", load: "Solo carico", unload: "Solo scarico" },
        nameLabel: "Azienda / stabilimento",
        addressLabel: "Indirizzo",
        postalCodeLabel: "Codice postale",
        cityLabel: "Località",
      ...
      shipment: {
        emptyTitle: "Non hai ancora percorsi abituali",
        needTwoLocations:
          "Hai bisogno di almeno 2 luoghi salvati (carico e scarico) prima di creare un percorso abituale.",
        emptyBody: "Salva i tragitti che ripeti per aggiungerli come spedizioni con un clic.",
        recipientPrefix: "Destinatario: ",
        nameLabel: "Nome del percorso (opzionale)",
        loadLocationLabel: "Luogo di carico",
        unloadLocationLabel: "Luogo di scarico",
        selectPlaceholder: "Seleziona un luogo salvato…",
        goodsLabel: "Merce abituale (opzionale)",
        weightLabel: "Peso abituale (opzionale)",
        recipientLabel: "Destinatario (opzionale)",
      },
    },
  },
  historico: {
  ...
  crear: {
    ...
    commercialShare: {
      ...
      destinationPostalCode: "CAP di disponibilità",
      destinationPostalCodeHint:
        "Il valore principale per l'abbinamento. L'indirizzo esatto non viene mai condiviso.",
      ...
      channels: { email: "E-mail", phone: "WhatsApp", both: "E-mail e WhatsApp" },
      preferredDestinationHint: "Per quale CAP ti interessa ricevere offerte?",
      preferredDestinationPostalCode: "CAP di destinazione preferita",
      preferredDestinationCountry: "Paese di destinazione preferita",
      ...
      vehicleTypeFrigolona: "Telonato refrigerato",
      vehicleTypeOtro: "Altro",
      vehicleTypeOtherPlaceholder: "Specifica il tipo",
