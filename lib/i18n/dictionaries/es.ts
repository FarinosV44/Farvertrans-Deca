...
export const es = {
  ...
  landing: {
    ...
    integrationsCard: {
      ...
      body: "Estamos preparando integraciones para empresas que necesitan conectar DeCA Profesional con sus sistemas. Formarán parte de las soluciones Business.",
    ...
    plans: {
      ...
      launchBadge: "Ahora: gratis hasta el 31/12/2026",
      reassurance:
      ...
      apiDisclaimer:
        "API e integraciones ERP/TMS sujetas a disponibilidad técnica y compatibilidad con el sistema del cliente.",
      tiers: [
        {
          name: "Starter",
        ...
        },
        {
          ...
          features: [
            ...
            { label: "Conservación documental 2 años", soon: true },
            { label: "Soporte prioritario por email", soon: true },
          ],
        },
        {
          name: "Business",
          ...
          features: [
            { label: "API", soon: true },
            { label: "Integraciones ERP / TMS", soon: true },
  ...
  panel: {
    ...
    help: {
      ...
      none: "No has abierto ninguna incidencia.",
      view: "Ver",
