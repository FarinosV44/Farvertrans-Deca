...
export const es = {
  ...
  auth: {
    ...
    commercialOptIn: {
      brand: "DECA Conecta",
      tagline: "Tu destino puede conectarte con tu próxima carga.",
      label: "Avísame si aparece una oportunidad de carga compatible con mis rutas",
      hint: "Al activarlo, autorizas el uso del destino y la fecha de tus portes para recibir propuestas comerciales personalizadas. No compartimos tu DeCA completo ni realizamos seguimiento GPS. Puedes cambiar esta decisión cuando quieras.",
      moreInfo: "Cómo funciona DECA Conecta y qué datos se utilizan",
      articleLink: "Descubre cómo funciona DECA Conecta",
      info: {
        howTitle: "¿Cómo funciona?",
        howBody:
          "Cuando generas un DeCA, la plataforma conoce el destino y la fecha prevista del porte. Si lo autorizas, DECA Conecta puede utilizar esos datos para identificar oportunidades de carga compatibles y permitir que cargadores interesados te envíen una propuesta comercial personalizada.",
        matchTitle: "Datos utilizados para encontrar oportunidades",
        matchItems: [
          "Lugar de destino del camión.",
          "Fecha del porte o de disponibilidad prevista.",
        ],
        contactTitle: "Datos utilizados para contactar contigo",
        contactItems: [
          "Empresa o nombre autorizado.",
          "Correo electrónico o teléfono que hayas autorizado.",
        ],
        neverTitle: "No compartimos",
        neverItems: [
          "El DeCA completo.",
          "El origen del porte.",
        ...
        controlBody:
          "Recibir una propuesta no obliga a aceptarla. Puedes desactivar DECA Conecta o cambiar tus preferencias cuando quieras sin perder el acceso al generador de DeCA.",
      },
    },
    submit: {
  ...
  panel: {
    ...
    privacy: {
      title: "Privacidad",
      intro:
        "DECA Conecta te permite recibir oportunidades de carga basadas en el destino y la fecha de tus portes. Es un servicio opcional: no activarlo no afecta a la creación, gestión o conservación de tus DeCA ni al uso gratuito de la plataforma.",
      freeUseNote:
        "Rechazar o retirar el consentimiento no afecta en nada al uso gratuito de DeCA Profesional.",
      tagline: "Tu destino puede conectarte con tu próxima carga.",
      supporting:
        "Tú decides si DeCA Profesional puede comunicar determinados datos de disponibilidad a cargadores interesados en enviarte propuestas comerciales personalizadas y preferentes de carga. Puedes cambiar esta decisión cuando quieras.",
      articleLink: "Descubre cómo funciona DECA Conecta",
      sectionTitle: "DECA Conecta",
      modeLegend: "¿Cuándo quieres activar DECA Conecta?",
      modes: {
        none: "No compartir en ningún porte",
        noneHint: "Ningún dato comercial sale de tus DeCA. Es la opción predeterminada.",
        perDeca: "Preguntarme en cada DeCA",
        perDecaHint:
          "Lo decides porte a porte al crear cada DeCA. La opción aparecerá desactivada por defecto.",
        all: "Compartir en todos los portes, salvo que lo desactive",
        allHint:
          "Se preparará la disponibilidad para cada nuevo DeCA. Podrás desactivarla en cualquier porte concreto antes de emitirlo.",
      },
      disclosureTitle: "Qué datos se utilizan y quién puede recibirlos",
      disclosure: {
        howTitle: "¿Cómo funciona?",
        howBody:
          "Cuando generas un DeCA, la plataforma conoce el destino y la fecha prevista del porte. Si lo autorizas, DECA Conecta puede utilizar esos datos para identificar oportunidades de carga compatibles y permitir que cargadores interesados te envíen una propuesta comercial personalizada.",
        ...
        recipients:
          "Destinatarios: cargadores interesados en ofrecer una propuesta comercial personalizada y preferente de carga.",
        purpose:
          "Finalidad: identificar oportunidades de carga compatibles con el destino y la fecha previstos y permitir que el transportista reciba la correspondiente propuesta comercial.",
        revocation:
          "Revocación: el usuario puede cambiar la preferencia para futuros usos en cualquier momento. Revocar el consentimiento no elimina ni invalida los DeCA ya generados.",
      },
    ...
    /** #113/#141 audit sweep (D-246) — `app/panel/datos` + `DatosHabitualesManager` (`saved-data-manager.tsx`). */
    datos: {
      intro: "Guarda y reutiliza los datos que utilizas a menudo para crear tus DeCA más rápido.",
      ...
      searchLabel: "Buscar en datos habituales",
      searchPlaceholder: "Buscar en datos habituales…",
      addMenuTrigger: "+ Añadir dato habitual",
      addMenuItem: (label: string) => `+ Añadir ${label}`,
      saveError: "No se pudo guardar. Revisa los datos.",
      offlineError: "Sin conexión.",
      removeError: "No se pudo eliminar.",
      tabsLabel: "Categorías de datos habituales",
      footerNote:
        "Editar o borrar un dato habitual no cambia ningún DeCA ya generado: cada documento guarda su propia copia.",
      noResults: "Ningún resultado para esta búsqueda en esta categoría.",
      use: "Usar",
      edit: "Editar",
      close: "Cerrar",
      delete: "Borrar",
      ...
      save: "Guardar",
      cancel: "Cancelar",
      addFirst: (label: string) => `+ Añadir primer ${label}`,
      add: (label: string) => `+ Añadir ${label}`,
      addTitle: (label: string) => `Añadir ${label}`,
      duplicateFoundPrefix: "Ya existe un dato parecido: ",
      useExisting: "Usar el existente",
      saveAnyway: "Guardar de todas formas",
      tabs: {
        company: "Empresas y contactos",
        vehicle: "Vehículos",
        location: "Lugares",
        shipment: "Rutas / envíos habituales",
      },
      addLabels: {
        company: "empresa",
        vehicle: "vehículo",
      ...
      company: {
        ...
        emptyBody:
          "Guarda cargadores y transportistas habituales para rellenar tus DeCA en segundos.",
        ...
        postalCodeLabel: "Código postal",
        cityLabel: "Población / localidad",
        contactNameLabel: "Persona de contacto (opcional)",
        contactPhoneLabel: "Teléfono de contacto (opcional)",
        contactEmailLabel: "Email de contacto (opcional)",
      },
      vehicle: {
        emptyTitle: "Aún no tienes vehículos guardados",
        emptyBody:
          "Guarda tus tractoras y remolques habituales para no volver a escribir la matrícula.",
        trailerPrefix: "Remolque ",
        aliasLabel: "Alias (opcional, p. ej. «Camión 1»)",
        tractorLabel: "Matrícula tractora",
        trailerLabel: "Matrícula remolque (opcional)",
      },
      location: {
        typeLabel: { load: "Carga", unload: "Descarga", both: "Carga y descarga" },
        emptyTitle: "Aún no tienes lugares guardados",
        emptyBody:
          "Guarda almacenes, fábricas y destinos habituales para rellenar tus DeCA en segundos.",
        usageFieldLabel: "Uso habitual",
        usageOptions: { both: "Carga y descarga", load: "Solo carga", unload: "Solo descarga" },
        nameLabel: "Empresa / establecimiento",
        addressLabel: "Dirección",
        postalCodeLabel: "Código postal",
        cityLabel: "Localidad",
      ...
      shipment: {
        ...
        emptyBody: "Guarda los trayectos que repites para añadirlos como envíos con un clic.",
        recipientPrefix: "Destinatario: ",
        nameLabel: "Nombre de la ruta (opcional)",
        loadLocationLabel: "Lugar de carga",
        unloadLocationLabel: "Lugar de descarga",
        selectPlaceholder: "Selecciona un lugar guardado…",
        goodsLabel: "Mercancía habitual (opcional)",
  ...
  historico: {
    ...
    noResultsFiltered: "No se han encontrado DeCA",
    noResultsFilteredHint: "Prueba a modificar los filtros o borrar algún criterio de búsqueda.",
  ...
  crear: {
    ...
    commercialShare: {
      ...
      finalShipmentLabel: "¿Cuál es la descarga final?",
      finalShipmentHint:
        "Solo para calcular la disponibilidad comercial — no cambia el orden ni la numeración jurídica de los envíos.",
      ...
      capacityPartial: "Grupaje",
      capacityPartialHint: "Solo tienes parte del espacio disponible.",
      linearMeters: "Metros lineales disponibles",
      maxWeightKg: "Peso máximo disponible (kg)",
      ...
      vehicleTypeFrigolona: "Frigolona",
      vehicleTypeOtro: "Otro",
      vehicleTypeOtherPlaceholder: "Especifica el tipo",
      privacyTitle: "Tu información comercial permanece privada.",
      privacyBody:
        "DECA Conecta solo reutiliza del DeCA la zona y la fecha en que el vehículo quedará disponible. No comparte empresas, clientes, cargadores, destinatarios, mercancía, peso del DeCA, matrículas, precio, PDF, QR ni ubicación GPS.",
      privacyVoluntary:
        "El destino preferente, el tipo de vehículo y la capacidad disponible son datos que tú indicas voluntariamente para recibir ofertas compatibles.",
