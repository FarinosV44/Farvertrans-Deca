...
export const de = {
  ...
  panel: {
    ...
    datos: {
      intro:
        "Speichern und verwenden Sie die Daten, die Sie häufig nutzen, um Ihre DeCA schneller zu erstellen.",
      countLabel: (c: { company: number; vehicle: number; location: number; shipment: number }) =>
        `${c.company} Unternehmen · ${c.vehicle} Fahrzeuge · ${c.location} Orte · ${c.shipment} Routen`,
      searchLabel: "In gespeicherten Daten suchen",
      searchPlaceholder: "In gespeicherten Daten suchen…",
      addMenuTrigger: "+ Gespeicherte Daten hinzufügen",
      addMenuItem: (label: string) => `+ ${label} hinzufügen`,
      saveError: "Konnte nicht gespeichert werden. Überprüfen Sie die Daten.",
      offlineError: "Keine Verbindung.",
      removeError: "Konnte nicht gelöscht werden.",
      tabsLabel: "Kategorien gespeicherter Daten",
      footerNote:
        "Das Bearbeiten oder Löschen gespeicherter Daten ändert keinen bereits erstellten DeCA: jedes Dokument behält seine eigene Kopie.",
      noResults: "Keine Ergebnisse für diese Suche in dieser Kategorie.",
      use: "Verwenden",
      edit: "Bearbeiten",
      close: "Schließen",
      delete: "Löschen",
      ...
      save: "Speichern",
      cancel: "Abbrechen",
      addFirst: (label: string) => `+ Ersten ${label} hinzufügen`,
      add: (label: string) => `+ ${label} hinzufügen`,
      addTitle: (label: string) => `${label} hinzufügen`,
      duplicateFoundPrefix: "Ähnlicher Eintrag existiert bereits: ",
      useExisting: "Vorhandenen verwenden",
      saveAnyway: "Trotzdem speichern",
      tabs: {
        company: "Unternehmen und Kontakte",
        vehicle: "Fahrzeuge",
        location: "Orte",
        shipment: "Häufige Routen / Sendungen",
      },
      addLabels: {
        company: "Unternehmen",
        vehicle: "Fahrzeug",
      ...
      company: {
        roleLabel: {
          ...
          carrier: "Ausführender Frachtführer",
          both: "Verlader und Frachtführer",
        },
        emptyTitle: "Sie haben noch keine gespeicherten Unternehmen",
        emptyBody:
          "Speichern Sie häufige Verlader und Frachtführer, um Ihre DeCA in Sekunden auszufüllen.",
        contactPrefix: "Kontakt: ",
        roleFieldLabel: "Übliche Rolle",
        nameLabel: "Name oder Firmenbezeichnung",
        nifLabel: "Steuernummer",
        addressLabel: "Anschrift",
        postalCodeLabel: "Postleitzahl",
        cityLabel: "Ort",
        contactNameLabel: "Ansprechpartner (optional)",
        contactPhoneLabel: "Kontakttelefon (optional)",
        contactEmailLabel: "Kontakt-E-Mail (optional)",
      },
      vehicle: {
        emptyTitle: "Sie haben noch keine gespeicherten Fahrzeuge",
        emptyBody:
          "Speichern Sie Ihre üblichen Zugmaschinen und Anhänger, damit Sie das Kennzeichen nie wieder eingeben müssen.",
        trailerPrefix: "Anhänger ",
        aliasLabel: "Alias (optional, z. B. «LKW 1»)",
        tractorLabel: "Kennzeichen Zugmaschine",
        trailerLabel: "Kennzeichen Anhänger (optional)",
      },
      location: {
        typeLabel: { load: "Beladung", unload: "Entladung", both: "Beladung und Entladung" },
        emptyTitle: "Sie haben noch keine gespeicherten Orte",
        emptyBody:
          "Speichern Sie Lager, Fabriken und häufige Ziele, um Ihre DeCA in Sekunden auszufüllen.",
        usageFieldLabel: "Übliche Nutzung",
        usageOptions: {
          both: "Beladung und Entladung",
          load: "Nur Beladung",
          unload: "Nur Entladung",
        },
        nameLabel: "Unternehmen / Standort",
        addressLabel: "Adresse",
        postalCodeLabel: "Postleitzahl",
        cityLabel: "Ort",
      ...
      shipment: {
        emptyTitle: "Sie haben noch keine häufigen Routen",
        needTwoLocations:
          "Sie benötigen mindestens 2 gespeicherte Orte (Beladung und Entladung), bevor Sie eine häufige Route erstellen können.",
        emptyBody:
          "Speichern Sie die Strecken, die Sie wiederholen, um sie mit einem Klick als Sendungen hinzuzufügen.",
        recipientPrefix: "Empfänger: ",
        nameLabel: "Routenname (optional)",
        loadLocationLabel: "Beladeort",
        unloadLocationLabel: "Entladeort",
        selectPlaceholder: "Wählen Sie einen gespeicherten Ort…",
        goodsLabel: "Übliche Ware (optional)",
        weightLabel: "Übliches Gewicht (optional)",
        recipientLabel: "Empfänger (optional)",
      },
    },
  },
  historico: {
