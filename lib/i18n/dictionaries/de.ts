...
export const de = {
  ...
  historico: {
    ...
    truncatedNotice: (total: number, cap: number) =>
      `Es werden die ${cap} neuesten von insgesamt ${total} Dokumenten angezeigt. Verwenden Sie die Filter, um Ihre Suche einzugrenzen — ältere Dokumente werden hier nicht angezeigt.`,
  ...
  crear: {
    ...
    commercialShare: {
      ...
      channels: { email: "E-Mail", phone: "WhatsApp", both: "E-Mail und WhatsApp" },
      preferredDestinationHint: "Für welche Postleitzahl möchten Sie Angebote erhalten?",
      preferredDestinationPostalCode: "Postleitzahl des bevorzugten Ziels",
      preferredDestinationCountry: "Land des bevorzugten Ziels",
