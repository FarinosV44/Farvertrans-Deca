...
export const en = {
  ...
  auth: {
    ...
    submit: {
      ...
      login: "Log in",
      busy: "One moment…",
      busyRegister: "Creating your account…",
    },
  ...
  panel: {
    ...
    datos: {
      intro: "Save and reuse the data you use often to create your DeCA faster.",
      countLabel: (c: { company: number; vehicle: number; location: number; shipment: number }) =>
        `${c.company} companies · ${c.vehicle} vehicles · ${c.location} places · ${c.shipment} routes`,
      searchLabel: "Search saved data",
      searchPlaceholder: "Search saved data…",
      addMenuTrigger: "+ Add saved data",
      addMenuItem: (label: string) => `+ Add ${label}`,
      saveError: "Couldn't save. Check the data.",
      offlineError: "No connection.",
      removeError: "Couldn't delete.",
      tabsLabel: "Saved data categories",
      footerNote:
        "Editing or deleting saved data doesn't change any already-generated DeCA: each document keeps its own copy.",
      noResults: "No results for this search in this category.",
      use: "Use",
      edit: "Edit",
      close: "Close",
      delete: "Delete",
      ...
      save: "Save",
      cancel: "Cancel",
      addFirst: (label: string) => `+ Add your first ${label}`,
      add: (label: string) => `+ Add ${label}`,
      addTitle: (label: string) => `Add ${label}`,
      duplicateFoundPrefix: "Something similar already exists: ",
      ...
      tabs: {
        ...
        vehicle: "Vehicles",
        location: "Places",
        shipment: "Frequent routes / shipments",
      },
      addLabels: {
        company: "company",
        vehicle: "vehicle",
      ...
      company: {
        ...
        emptyTitle: "You don't have any saved companies yet",
        emptyBody: "Save frequent shippers and carriers to fill in your DeCA in seconds.",
        contactPrefix: "Contact: ",
        roleFieldLabel: "Usual role",
        nameLabel: "Name or legal name",
        nifLabel: "Tax ID",
        addressLabel: "Address",
        postalCodeLabel: "Postal code",
        cityLabel: "City / town",
      ...
      vehicle: {
        emptyTitle: "You don't have any saved vehicles yet",
        emptyBody:
          "Save your usual tractors and trailers so you never have to type the plate again.",
        trailerPrefix: "Trailer ",
        aliasLabel: "Alias (optional, e.g. «Truck 1»)",
        tractorLabel: "Tractor plate",
        trailerLabel: "Trailer plate (optional)",
      },
      location: {
        typeLabel: { load: "Loading", unload: "Unloading", both: "Loading and unloading" },
        emptyTitle: "You don't have any saved places yet",
        emptyBody:
          "Save warehouses, factories and frequent destinations to fill in your DeCA in seconds.",
        usageFieldLabel: "Usual use",
        usageOptions: {
          both: "Loading and unloading",
          load: "Loading only",
          unload: "Unloading only",
        },
        nameLabel: "Company / site",
        addressLabel: "Address",
        postalCodeLabel: "Postal code",
        cityLabel: "City",
      ...
      shipment: {
        emptyTitle: "You don't have any frequent routes yet",
        needTwoLocations:
          "You need at least 2 saved places (loading and unloading) before creating a frequent route.",
        emptyBody: "Save the routes you repeat to add them as shipments in one click.",
        recipientPrefix: "Recipient: ",
        nameLabel: "Route name (optional)",
        loadLocationLabel: "Loading place",
        unloadLocationLabel: "Unloading place",
        selectPlaceholder: "Select a saved place…",
        goodsLabel: "Usual goods (optional)",
        weightLabel: "Usual weight (optional)",
  ...
  historico: {
    ...
    noResultsFiltered: "No DeCA found",
    noResultsFilteredHint: "Try adjusting the filters or clearing a search criterion.",
  ...
  crear: {
    ...
    commercialShare: {
      ...
      channels: { email: "Email", phone: "WhatsApp", both: "Email and WhatsApp" },
      preferredDestinationHint: "Which postal code would you like to receive offers for?",
      preferredDestinationPostalCode: "Preferred destination postal code",
      preferredDestinationCountry: "Preferred destination country",
      ...
      capacityPartialHint: "You only have part of the space available.",
      linearMeters: "Available linear metres",
      maxWeightKg: "Maximum available weight (kg)",
      ...
      privacyVoluntary:
        "Preferred destination, vehicle type and available capacity are data you provide voluntarily to receive compatible offers.",
