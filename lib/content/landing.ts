...
/**
 * Compact trust row under the hero. "Registro gratuito" (not "sin registro")
 * since PRIORITY 1's hard gate (D-052) — a DeCA can only be finally
 * generated by a registered, authenticated user; only filling the form is
 * ever anonymous.
 */
export const TRUST_ROW = ["Registro gratuito", "PDF + QR", "Custodia digital", "Histórico"];
