  ...
  return (
    <div>
      ...
      {isCorrection ? (
        ...
        showLeadGate && (
          <p className="mt-2 text-sm text-[var(--color-text-muted)]">
            Completa los datos sin compromiso — solo te pediremos tu nombre y email al final, sin
            ...
            {showLeadGate && (
              ...
              >
                <p className="font-bold text-[var(--color-primary)]">
                  Solo un paso más: ¿a quién enviamos el DeCA?
                </p>
                <p className="mt-1 text-sm">
                  Tu nombre y email, solo para enviarte el enlace de descarga. Sin crear cuenta.
                </p>
                <Field
                  id="leadName"
                  label="Tu nombre"
                ...
                />
                <p className="mt-1 text-sm">
                  <Link href="/entrar?next=%2Fcrear">¿Ya tienes cuenta? Entra</Link> para usar tus
                  datos guardados.
                </p>
              </div>
            )}
